...
import i1 from "../../assets/images/image-gallery-1-512x512.jpg";
import i2 from "../../assets/images/image-gallery-2-512x512.jpg";
import i3 from "../../assets/images/image-gallery-3-512x512.jpg";
import i4 from "../../assets/images/image-gallery-4-512x512.jpg";
import i5 from "../../assets/images/image-gallery-5-512x512.jpg";
import i6 from "../../assets/images/image-gallery-6-512x512.jpg";
import i7 from "../../assets/images/image-gallery-7-512x512.jpg";
import i8 from "../../assets/images/image-gallery-8-512x512.jpg";
        ...
        >
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3 isotope-item">
            ...
            <article className="thumbnail-classic">
              <a
                className="thumbnail-classic-figure"
                href="images/image-gallery-3-1200x800.jpg"
                data-lightgallery="item"
              >
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3 isotope-item">
            ...
            <article className="thumbnail-classic">
              <a
                className="thumbnail-classic-figure"
                href="images/image-gallery-4-1200x800.jpg"
                data-lightgallery="item"
              >
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3 isotope-item">
            ...
            <article className="thumbnail-classic">
              <a
                className="thumbnail-classic-figure"
                href="images/image-gallery-5-1200x800.jpg"
                data-lightgallery="item"
              >
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3 isotope-item">
            ...
            <article className="thumbnail-classic">
              <a
                className="thumbnail-classic-figure"
                href="images/image-gallery-7-1200x800.jpg"
                data-lightgallery="item"
              >
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3 isotope-item">
            ...
            <article className="thumbnail-classic">
              <a
                className="thumbnail-classic-figure"
                href="images/image-gallery-8-1200x800.jpg"
                data-lightgallery="item"
              >
